...
- **Commit for the results reported here:** *to be pinned at posting; the per-file pins in Papers
  II and III name the state of the code that produced their numbers, which is what a replicator
  needs today.*
