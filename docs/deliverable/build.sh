...
cp "$OUT/main.pdf" "$HERE/wealth-tensor-capture.pdf"
PAGES=$(python3 -c "import pypdf;print(len(pypdf.PdfReader('$HERE/wealth-tensor-capture.pdf').pages))")
echo "  ok      wealth-tensor-capture.pdf — $PAGES pages"
